...
const MainContainer = styled.div`
  ...
  height: calc(100vh - 100px); // Высота минус 100px сверху
  position: relative;
`;
  ...
  return (
    <MainContainer>
      <Container className="container">
        ...
        <SubTitle>
          Your all-in-one solution for organizing tasks and projects
        </SubTitle>

        <Description>
          Manage your work, collaborate with your team, and keep track of
          deadlines with our powerful task manager. Whether you're organizing
          personal tasks or collaborating with a team, this application will
          help you stay on top of everything. You can access your tasks from
          anywhere and stay productive no matter what.
        </Description>

        <Description>
          Features include task tracking, customizable boards, and intuitive
          interfaces to boost your productivity. Organize your work by creating
          boards, adding tasks, setting deadlines, and more. You can collaborate
          with your team in real-time, ensuring smooth workflows and improved
          efficiency.
        </Description>
        ...
        <AdditionalSection>
          ...
          <AdditionalDescription>
            Stay organized and meet your deadlines with ease. The Task Manager
            helps you focus on the important things by letting you prioritize
            your tasks, set reminders, and track progress. With customizable
            boards and tasks, you can organize your work the way that suits you
            best.
          </AdditionalDescription>

          <AdditionalTitle>Seamless Collaboration</AdditionalTitle>
          <AdditionalDescription>
            Share boards with your team and collaborate in real-time. Everyone
            can view and update tasks, leave comments, and track progress. Say
            goodbye to miscommunication and hello to better teamwork and project
            management!
          </AdditionalDescription>

          <AdditionalTitle>Customizable & Accessible</AdditionalTitle>
          <AdditionalDescription>
            Personalize your workspace with themes and layouts that match your
            style. Whether you're working from home or on-the-go, access your
            tasks and boards from any device, anytime. Stay on top of your work
        ...
        <Features>
          ...
          <FeatureItem>
            Stay organized with reminders and priority settings
          </FeatureItem>
        </Features>
        ...
        <RoleSection>
          ...
          <RoleDescription>
            This application offers different roles to customize your
            experience. Whether you are a team member, manager, or admin, you
            can manage tasks according to your permissions and responsibility
            levels. We provide flexible user roles that make task management
            seamless.
          </RoleDescription>
          ...
          <Diagram>
            <div>
              ...
              <p>
                View and update tasks, participate in collaborations, set
                deadlines.
              </p>
            </div>
            <ArrowIcon>→</ArrowIcon>
            ...
            <div>
              ...
              <p>
                Full control over task management, user permissions, and team
                settings.
              </p>
            </div>
          </Diagram>
